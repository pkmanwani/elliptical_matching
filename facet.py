...
final_sigma_x = pf.sigma_beam(min(beta_x_values),emit_nx,gamma)
final_sigma_y = pf.sigma_beam(min(beta_y_values),emit_nx,gamma)
...
print(rf'Final spot size PIC ($\sigma_x/kpn1$,$\sigma_y$/kpn1,sigma_z/kpn1): {final_sigma_x/kpn1[0],final_sigma_y/kpn1[0],sigma_z/kpn1[0]}')
